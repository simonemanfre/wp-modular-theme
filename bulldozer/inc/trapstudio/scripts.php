<?php 
	...
	function site_scripts_and_css() {
        ...
        wp_enqueue_style('slick', get_template_directory_uri() . "/assets/css/slick.css", array('normalize'), $dati_tema->Version);
        wp_enqueue_style('style', get_stylesheet_uri(), array('normalize'), $dati_tema->Version);
        wp_enqueue_style('responsive', get_template_directory_uri() . "/assets/css/responsive.css", array('style'), $dati_tema->Version, '(min-width: 480px)');
